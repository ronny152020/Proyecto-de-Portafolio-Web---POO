...
function getData(){
  ...
  */
  ...
  document.write('</div>');
  document.write('<p class="frase4">Gracias <br/> por su inscripcion, le saluda<br/>Ronny Mozo</p>');
  document.write('<p class="frase1"> '+nombre+' revise su correo => '+email+' <= <br/>para confirmar su registro </p>');
